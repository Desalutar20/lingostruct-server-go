...
func (h *Handler) SignUp(w http.ResponseWriter, r *http.Request) {
	...
	data, err := httputils.ParseData[dto.SignUpRequest](w, r.Body)
	if err != nil {
		return
	}

	if err := h.service.SignUp(r.Context(), data); err != nil {
		apperror.HandleError(w, err, logger)
		return
	}

	httputils.SuccessResponse(w, "Check your email to verify your account", http.StatusCreated)
}
